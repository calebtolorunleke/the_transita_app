      ...
      <div className="flex flex-col justify-between gap-10 h-screen py-5 md:py-20 mx-4 md:mx-12">
        <div className="flex flex-col gap-10 w-full">
          ...
          <div className="mx-auto w-full max-w-[100%] md:max-w-[70%] flex flex-col gap-5">
            <h1 className="font-bold text-md md:text-xl">Reset Password</h1>
            <label>Email address</label>
            <input
              type="email"
              className="border border-gray-400 border-2 w-full py-2 px-4 rounded semi-bold focus:outline-none"
              placeholder="kayodeyusuf2@gmail.com"
            />
          </div>
        </div>
